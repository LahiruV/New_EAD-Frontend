...
const AddInventory = () => {
    ...
    const validateForm = () => {
        ...
        if (newObject.stockAlert === null) {
            errors.stockAlert = 'Stock Alert is required';
            isValid = false;
        }
        setErrors(errors);
        return isValid;
                    ...
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs={12}>
                            <FormControl fullWidth>
                                <InputLabel id="stockAlert">Stock Alert</InputLabel>
                                <Select
                                    labelId="stockAlert"
                                    value={newObject.stockAlert}
                                    onChange={(e) => setNewObject({ ...newObject, stockAlert: e.target.value })}
